...
:root {
  /* Backgrounds */
  --bg-base: oklch(0.1 0.02 30); /* near-black warm */
  ...
  --primary-hover: oklch(0.82 0.2 65); /* lighter on hover */
  --primary-dim: oklch(0.65 0.12 65); /* muted state */

  /* Semantic */
  --win-green: oklch(0.72 0.18 145); /* player win state */
  --loss-red: oklch(0.58 0.2 25); /* player loss state */
  --vrf-blue: oklch(0.7 0.12 240); /* VRF proof accent — use sparingly */
