...
export const leaderboardSnapshots = pgTable(
  'leaderboard_snapshots',
  {
    ...
    totalVolumeMicroalgo: bigint('total_volume_microalgo', { mode: 'bigint' }).notNull().default(0n),
    winsAmountMicroalgo: bigint('wins_amount_microalgo', { mode: 'bigint' }).notNull().default(0n),
    lossesAmountMicroalgo: bigint('losses_amount_microalgo', { mode: 'bigint' }).notNull().default(0n),
