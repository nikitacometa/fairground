...
| lint          | ESLint + Prettier + Husky + lint-staged               | eslint@10.4.1 (flat config), typescript-eslint@8.60.0, @eslint/js@10.0.1, globals@17.6.0, eslint-config-prettier@10.1.8, prettier@3.8.3, husky@9.1.7, lint-staged@17.0.6 | `no-floating-promises=error`, `no-explicit-any=error`. Config: `eslint.config.mjs` (flat config). No `.eslintrc.*` files.                       |
